 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartnerInvoiceCreditRequestV2Model implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['invoice_credit_request'] === null) {
            $invalidProperties[] = "'invoice_credit_request' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\InvoiceCreditRequestV2Model $invoice_credit_request invoice_credit_request
     *
     * @return $this
     */
